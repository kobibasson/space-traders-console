...
// @ts-ignore
import type { GetConstruction200Response } from '../models';
// @ts-ignore
import type { GetJumpGate200Response } from '../models';
// @ts-ignore
import type { GetMarket200Response } from '../models';
// @ts-ignore
import type { GetShipyard200Response } from '../models';
// @ts-ignore
import type { GetSystem200Response } from '../models';
// @ts-ignore
import type { GetSystemWaypoints200Response } from '../models';
// @ts-ignore
import type { GetSystemWaypointsTraitsParameter } from '../models';
// @ts-ignore
import type { GetSystems200Response } from '../models';
// @ts-ignore
import type { GetWaypoint200Response } from '../models';
// @ts-ignore
import type { SupplyConstruction201Response } from '../models';
// @ts-ignore
import type { SupplyConstructionRequest } from '../models';
// @ts-ignore
import type { WaypointType } from '../models';
/**
...
export const SystemsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSystemWaypoints: async (systemSymbol: string, page?: number, limit?: number, type?: WaypointType, traits?: GetSystemWaypointsTraitsParameter, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'systemSymbol' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        supplyConstruction: async (systemSymbol: string, waypointSymbol: string, supplyConstructionRequest?: SupplyConstructionRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'systemSymbol' is not null or undefined
...
export const SystemsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getConstruction(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetConstruction200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getJumpGate(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetJumpGate200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getMarket(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetMarket200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getShipyard(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetShipyard200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getSystem(systemSymbol: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetSystem200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getSystemWaypoints(systemSymbol: string, page?: number, limit?: number, type?: WaypointType, traits?: GetSystemWaypointsTraitsParameter, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetSystemWaypoints200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getSystems(page?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetSystems200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getWaypoint(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetWaypoint200Response>> {
         ...
         * @throws {RequiredError}
         */
        async supplyConstruction(systemSymbol: string, waypointSymbol: string, supplyConstructionRequest?: SupplyConstructionRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SupplyConstruction201Response>> {
...
export const SystemsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getConstruction(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): AxiosPromise<GetConstruction200Response> {
         ...
         * @throws {RequiredError}
         */
        getJumpGate(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): AxiosPromise<GetJumpGate200Response> {
         ...
         * @throws {RequiredError}
         */
        getMarket(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): AxiosPromise<GetMarket200Response> {
         ...
         * @throws {RequiredError}
         */
        getShipyard(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): AxiosPromise<GetShipyard200Response> {
         ...
         * @throws {RequiredError}
         */
        getSystem(systemSymbol: string, options?: RawAxiosRequestConfig): AxiosPromise<GetSystem200Response> {
         ...
         * @throws {RequiredError}
         */
        getSystemWaypoints(systemSymbol: string, page?: number, limit?: number, type?: WaypointType, traits?: GetSystemWaypointsTraitsParameter, options?: RawAxiosRequestConfig): AxiosPromise<GetSystemWaypoints200Response> {
         ...
         * @throws {RequiredError}
         */
        getSystems(page?: number, limit?: number, options?: RawAxiosRequestConfig): AxiosPromise<GetSystems200Response> {
         ...
         * @throws {RequiredError}
         */
        getWaypoint(systemSymbol: string, waypointSymbol: string, options?: RawAxiosRequestConfig): AxiosPromise<GetWaypoint200Response> {
         ...
         * @throws {RequiredError}
         */
        supplyConstruction(systemSymbol: string, waypointSymbol: string, supplyConstructionRequest?: SupplyConstructionRequest, options?: RawAxiosRequestConfig): AxiosPromise<SupplyConstruction201Response> {
...
export class SystemsApi extends BaseAPI {
     ...
     * @memberof SystemsApi
     */
    public getSystemWaypoints(systemSymbol: string, page?: number, limit?: number, type?: WaypointType, traits?: GetSystemWaypointsTraitsParameter, options?: RawAxiosRequestConfig) {
     ...
     * @memberof SystemsApi
     */
    public supplyConstruction(systemSymbol: string, waypointSymbol: string, supplyConstructionRequest?: SupplyConstructionRequest, options?: RawAxiosRequestConfig) {
