...
// @ts-ignore
import type { GetFaction200Response } from '../models';
// @ts-ignore
import type { GetFactions200Response } from '../models';
/**
...
export const FactionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getFaction(factionSymbol: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetFaction200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getFactions(page?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetFactions200Response>> {
...
export const FactionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getFaction(factionSymbol: string, options?: RawAxiosRequestConfig): AxiosPromise<GetFaction200Response> {
         ...
         * @throws {RequiredError}
         */
        getFactions(page?: number, limit?: number, options?: RawAxiosRequestConfig): AxiosPromise<GetFactions200Response> {
