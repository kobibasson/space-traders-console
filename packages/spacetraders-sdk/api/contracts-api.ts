...
// @ts-ignore
import type { AcceptContract200Response } from '../models';
// @ts-ignore
import type { DeliverContract200Response } from '../models';
// @ts-ignore
import type { DeliverContractRequest } from '../models';
// @ts-ignore
import type { FulfillContract200Response } from '../models';
// @ts-ignore
import type { GetContract200Response } from '../models';
// @ts-ignore
import type { GetContracts200Response } from '../models';
/**
...
export const ContractsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deliverContract: async (contractId: string, deliverContractRequest?: DeliverContractRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'contractId' is not null or undefined
...
export const ContractsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async acceptContract(contractId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AcceptContract200Response>> {
         ...
         * @throws {RequiredError}
         */
        async deliverContract(contractId: string, deliverContractRequest?: DeliverContractRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DeliverContract200Response>> {
         ...
         * @throws {RequiredError}
         */
        async fulfillContract(contractId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FulfillContract200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getContract(contractId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetContract200Response>> {
         ...
         * @throws {RequiredError}
         */
        async getContracts(page?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetContracts200Response>> {
...
export const ContractsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        acceptContract(contractId: string, options?: RawAxiosRequestConfig): AxiosPromise<AcceptContract200Response> {
         ...
         * @throws {RequiredError}
         */
        deliverContract(contractId: string, deliverContractRequest?: DeliverContractRequest, options?: RawAxiosRequestConfig): AxiosPromise<DeliverContract200Response> {
         ...
         * @throws {RequiredError}
         */
        fulfillContract(contractId: string, options?: RawAxiosRequestConfig): AxiosPromise<FulfillContract200Response> {
         ...
         * @throws {RequiredError}
         */
        getContract(contractId: string, options?: RawAxiosRequestConfig): AxiosPromise<GetContract200Response> {
         ...
         * @throws {RequiredError}
         */
        getContracts(page?: number, limit?: number, options?: RawAxiosRequestConfig): AxiosPromise<GetContracts200Response> {
