...
// @ts-ignore
import type { GetStatus200Response } from '../models';
// @ts-ignore
...
export const GlobalApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getStatus(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetStatus200Response>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['GlobalApi.getStatus']?.[localVarOperationServerIndex]?.url;
        ...
        async register(registerRequest?: RegisterRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Register201Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['GlobalApi.register']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class GlobalApi extends BaseAPI {
    ...
    public register(registerRequest?: RegisterRequest, options?: RawAxiosRequestConfig) {
        return GlobalApiFp(this.configuration).register(registerRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
